...
const cipherButton = document.getElementById('decipher-button');
cipherButton.addEventListener('click', () => {
    ...
    decipherText.classList.add('decipher');
    decipherText.textContent = caesarDecipher(cipherText.value, cipherKey.value);
});