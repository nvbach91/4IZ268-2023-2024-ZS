...
const convertedCtoF = celsiusValue * 9 / 5 + 32;
const convertedFtoC = (fahrenheihtValue - 32) * 5 / 9;

console.log(`${celsiusValue}°C = ${convertedCtoF}°F`);
console.log(`${fahrenheihtValue}°F = ${convertedFtoC}°C`);
...
buttonGetAge.innerText = 'Pepes age';
buttonGetAge.setAttribute('id', 'task-1');
buttonGetAge.addEventListener('click', () => {
    console.log(`Pepe is ${getAge(2005)} years old`);
});
...
buttonCtoF.innerText = 'Convert To Fahrenheit';
...
buttonFtoC.innerText = 'Convert To Celsius';
...
const buttonGetCensored = document.createElement('button');
buttonGetCensored.innerText = '%CENSORED%';
buttonGetCensored.setAttribute('id', 'task-4');

buttonGetCensored.addEventListener('click', () => {
...
tasks4.appendChild(buttonGetCensored);
...
const buttonAroundAndAbout = document.createElement('button');
buttonAroundAndAbout.innerText = 'Around and about';
buttonAroundAndAbout.setAttribute('id', 'task-7');

buttonAroundAndAbout.addEventListener('click', () => {
...
tasks7.appendChild(buttonAroundAndAbout);
...
const buttonAnotherDimension = document.createElement('button');
buttonAnotherDimension.innerText = 'Another dimension';
buttonAnotherDimension.setAttribute('id', 'task-8');

buttonAnotherDimension.addEventListener('click', () => {
...
tasks8.appendChild(buttonAnotherDimension);
...
buttonGetTriangleArea.addEventListener('click', () => {
  const result = getTriangleArea(8,9,15);
