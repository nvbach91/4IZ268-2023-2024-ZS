...
const shiftChar = (c, shift) => {
    ...
    const shiftedI = (i - shift + 26) % 26;
    return alphabet.charAt(shiftedI);
...
const decipheredTextElement = document.getElementById("decipheredText");

document.getElementById("decipher").addEventListener("click", () => {
    const cipherText = document.getElementById("decipherText").value;
    ...
    if (!isNaN(usedKey)) {
        ...
        decipheredTextElement.textContent = "Invalid key. Please enter a valid number.";
    }
});
